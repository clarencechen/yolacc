...
coco_base_config = Config({
    ...
    # The mask prototype network produces coefficients as the output of each pred module then uses those
    # coefficients to linearly combine features from a prototype network to create image-sized masks.
    # Parameters:
